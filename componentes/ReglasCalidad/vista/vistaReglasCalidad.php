...
//extends Exception{
    ...
    public function __construct($datos) {
        ...
        $this->datos = $datos;
        $loader = new Twig_Loader_Filesystem(COMPONENTS_PATH . "ReglasCalidad/vista/tpl/");
        $this->plantilla = new Twig_Environment($loader, array('debug' => true, 'cache' => 'false', 'auto_reload' => 'true'));
    }

    public function mostrarReglasCalidad($permisos) {
        ...
        if($permisos->crear=="SI"){
            $crear =   '<table align="center" '
                                    ...
                                    . '<td align="right"> '
                                    . '<div class="popups"> '
                                    . '<a href="javascript:void(0)" onclick="agregarReglaCalidad(0)">'
                                    . '<input type="button" class="botonGeneralGrande" value="Crear Regla" />'
                                    . '</a></div></td></tr></table>';
        }

        echo $this->plantilla->render('listadoReglasCalidad.html', array('titulo' => 'RESUMEN REGLAS CALIDAD', 'idMenu' => $permisos->idMenu,'filtro' => $filtro,'crear'=>$crear));
    }

    function verReglasCalidad($idRegla){
        //echo'<pre>';print_r($datosUsuario[0]);echo'</pre>';
        echo $this->plantilla->render('verReglasCalidad.html',array('idRegla'=> $idRegla));
    ...
    function agregarReglaCalidad($arreglo) {
        ...
        echo $this->plantilla->render('editarReglaCalidad.html', $arreglo);
    }
