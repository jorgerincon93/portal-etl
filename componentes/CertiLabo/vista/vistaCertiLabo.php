    ...
    //extends Exception{
        ...
        function generarDesprenPdf($arreglo){
            ...
            echo $this->plantilla->render('generarDesprenPdf.html',array('datosEmpleado' => $arreglo["datosEmpleado"],'datosEnca'=>$arreglo["datosEnca"],'datosCertIngre'=>$arreglo["datosCertIngre"],'datosCertEgre'=>$arreglo["datosCertEgre"],'totales'=>$arreglo["totales"],'numCerti'=>$arreglo["numDespren"],'meses'=>$arreglo["meses"]));
        }

        function seleccionarPeriodo($arreglo){
            
            echo $this->plantilla->render('seleccionarPeriodo.html',$arreglo);
        }
