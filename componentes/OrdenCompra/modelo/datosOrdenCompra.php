...
class DatosOrdenCompra extends BDControlador{ 
    ...
    public function datosOrdenCompra($idOrden) {
        global $db;
	...
	//echo $query;	              
	$db->query($query);
        $contra = $this->datosOfertaEconomica($id);
        $this->logMovimiento($_SESSION['datos_logueo']['login'], "OfertaEconomica", $funcion = "Elimina Oferta Economica " . $contra->numeroContrato);
    ...
    function eliminarDesOferta($idOferta) {
        ...
        $db->query($query);
        $contra = $this->datosOfertaEconomica($id);
        $this->logMovimiento($_SESSION['datos_logueo']['login'], "OfertaEconomica", $funcion = "Elimina Detalle Oferta Economica " . $contra->numeroContrato);
